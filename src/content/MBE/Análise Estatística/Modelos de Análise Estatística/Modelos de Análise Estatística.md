...
> **Contínuo → linear; binário → logística; contagem/taxa → Poisson; tempo até evento → Cox.**

A regra orienta a escolha inicial, mas a distribuição dos dados, o desenho do estudo, a censura, o tempo sob risco e os pressupostos do modelo devem ser verificados antes da análise definitiva.
